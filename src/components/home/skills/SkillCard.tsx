...
export default function SkillCard({ skill }: SkillCardProps) {
    ...
    return (
        <div className="flex flex-col items-center gap-5 text-center group">
            <div className="w-full max-w-[120px] lg:max-w-[180px] aspect-square border border-transparent hover:border-pb-theme-primary hover:bg-pb-theme-primary/20 flex flex-col items-center justify-center gap-5 rounded-4xl duration-500 transition-all ease-in bg-pb-grey-2/50">
                <Image
                    src={icon}
                    alt={title}
                    width={80}
            ...
            <p className="text-pb-theme-primary lg:text-base font-medium">{title}</p>
        </div>
    );
}
